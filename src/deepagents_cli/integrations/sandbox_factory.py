...
def _run_sandbox_setup(backend: SandboxBackendProtocol, setup_script_path: str) -> None:
    ...
    console.print("[#00AEEF]✓ Setup complete[/#00AEEF]")
...
def create_modal_sandbox(
    *, sandbox_id: str | None = None, setup_script_path: str | None = None
    ...
    with app.run():
        ...
        console.print(f"[#00AEEF]✓ Modal sandbox ready: {backend.id}[/#00AEEF]")
...
def create_runloop_sandbox(
    *, sandbox_id: str | None = None, setup_script_path: str | None = None
    ...
    console.print(f"[#00AEEF]✓ Runloop devbox ready: {sandbox_id}[/#00AEEF]")
...
def create_daytona_sandbox(
    *, sandbox_id: str | None = None, setup_script_path: str | None = None
    ...
    console.print(f"[#00AEEF]✓ Daytona sandbox ready: {backend.id}[/#00AEEF]")
